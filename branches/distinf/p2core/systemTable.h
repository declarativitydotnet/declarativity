...
FUNCTIONDEF("f_sampleExponential", 1, "sampleexponential")
...
FUNCTIONDEF("f_registerVariable", 3, "register_variable")
FUNCTIONDEF("f_factor", 1, "factor")
FUNCTIONDEF("f_tableFactor", 2, "table_factor")
FUNCTIONDEF("f_canonicalGaussian", 3, "canonical_gaussian")
FUNCTIONDEF("f_momentGaussian", 3, "moment_gaussian")
FUNCTIONDEF("f_arguments", 1, "arguments")
FUNCTIONDEF("f_product", 1, "product")
FUNCTIONDEF("f_marginal", 2, "marginal")
FUNCTIONDEF("f_maximum", 2, "maximum")
FUNCTIONDEF("f_minimum", 2, "minimum")
FUNCTIONDEF("f_restrict", 3, "restrict")
FUNCTIONDEF("f_normalize", 1, "normalize")
FUNCTIONDEF("f_mean", 1, "mean")
FUNCTIONDEF("f_covariance", 1, "covariance")
FUNCTIONDEF("f_values", 1, "values")
FUNCTIONDEF("f_weightedUpdate", 3, "weighted_update")
FUNCTIONDEF("f_norm1", 2, "norm_1")
FUNCTIONDEF("f_normInf", 2, "norm_inf")
...
FUNCTIONDEF("f_addParameters", 2, "addparams")
