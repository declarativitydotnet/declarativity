...
namespace Sketches
{
  ...
  class FM
    ...
    public:
	 ...
	 uint16_t seed = 0x330E
      ...
      static Sketches::FM *unmarshal(boost::archive::text_iarchive *x);

      // compareTo for comparison at PEL level.
      virtual int compareTo(FM *f);
  ...
  class CountMinFM
    ...
    public:
      ...
      virtual void marshal(boost::archive::text_oarchive *x) const;
      static Sketches::CountMinFM *unmarshal(boost::archive::text_iarchive *x);
