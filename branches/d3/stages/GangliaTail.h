// -*- c-basic-offset: 2; related-file-name: "GangliaTail.C" -*-
/*
 * @(#)$$
 *
...
#ifndef _GANGLIATAIL_H_
#define _GANGLIATAIL_H_
...
class GangliaTail : public Stage::Processor {
public:
  GangliaTail(Stage* myStage);

  ~GangliaTail() {};

  /** The input schema for GangliaTail is <tupleName, location specifier,
  ...
  // factory.
  DECLARE_PUBLIC_STAGE_INITS(GangliaTail)
...
//std::ifstream _fileStream;
  ...
  static ValuePtr GangliaTailTuple;
