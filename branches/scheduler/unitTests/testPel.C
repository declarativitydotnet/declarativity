    ...
    ValuePtr top = vm.result_val();
   {
    ...
    // returned value
    {
      ...
      case Value::STR:
        ...
        break;
      case Value::ID:
        eq = Val_ID::cast(top)->toString() == t->val ? 1 : 0;
	BOOST_CHECK_MESSAGE(eq, testID
			    << "** '" << top->toString() << "','"
			    << t->val << "'");
...
testPel::vtests[] = {
  ...
  // >> (logical shift right)
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000000000I",  "0x0000000000000000000000000000000000000000I 160 >>"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000000001I",  "0x2I 1 >>"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000000000I",  "0x8000I 31 >>"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000000001I",  "0x80000000I 31 >>"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000008000I","0x20000I 2 >>"),
  ...
  TST(INT64, SUCCESS, "-1","0xffffffffffffffffU 1 >>"),
  TST(INT64, SUCCESS, "-1","-1 2 >>"), // Recall this is with sign
                                // extension, so '1' bits extend the
                                // last bit
  ...
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000000000I", "0x1I 160 <<"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000000002I", "0x1I 1 <<"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000080000000I", "0x1I 31 <<"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000008000I", "0x1I 15 <<"),
  TST(ID, SUCCESS,    "0x0000000000000000000000000000000000020000I", "0x8000I 2 <<"),
  TST(INT64, SUCCESS, "-2",	"-1 1 <<"),
  TST(INT64, SUCCESS, "-4",	"-1 ->i64 2 <<"),
  // & (bitwise AND)
  TST(INT64, STACK_UNDERFLOW, "",	"&"),
  TST(INT64, STACK_UNDERFLOW, "",	"1U &"),
  TST(INT64, SUCCESS, "1",	"1U 1 &"),
  TST(INT64, SUCCESS, "0",	"0U 3 &"),
  TST(INT64, SUCCESS, "0",	"3U 0 &"),
  TST(INT64, SUCCESS, "3",	"3U 3 &"),
  TST(INT64, SUCCESS, "3",	"7U 3 &"), 
  TST(INT64, SUCCESS, "0","0xf0f0fU 0xf0f0f0 &"),
  TST(INT64, SUCCESS, "0",	"0xffffffff00000000U 0xffffffff &"),
  TST(INT64, SUCCESS, "0x1010101010101010",	"0xffffffffffffffffU 0x1010101010101010 &"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000001I",	"0x1I 0x1I &"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000000I",	"0x0I 0x3I &"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000000I",	"0x3I 0x0I &"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000003I",	"0x3I 0x3I &"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000003I",	"0x7I 0x3I &"), 
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000000I","0xf0f0fI 0xf0f0f0I &"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000000I",	"0xffffffff00000000I 0xffffffffI &"),
  TST(ID, SUCCESS, "0x0000000000000000000000001010101010101010I",	"0xffffffffffffffffI 0x1010101010101010I &"),
  // | (bitwise inclusive OR)
  TST(INT64, STACK_UNDERFLOW, "",	"|"),
  TST(INT64, STACK_UNDERFLOW, "",	"1U |"),
  TST(INT64, SUCCESS, "1",	"1U 1 |"),
  TST(INT64, SUCCESS, "3",	"0U 3 |"),
  TST(INT64, SUCCESS, "3",	"3U 0 |"),
  TST(INT64, SUCCESS, "3",	"3U 3 |"),
  TST(INT64, SUCCESS, "7",	"7U 3 |"), 
  TST(INT64, SUCCESS, "0xffffff","0xf0f0fU 0xf0f0f0 |"),
  TST(INT64, SUCCESS, "-1",	"0xffffffff00000000U 0xffffffff |"),
  TST(INT64, SUCCESS, "-1",	"0xffffffffffffffffU 0x1010101010101010 |"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000001I",	"0x1I 0x1I |"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000003I",	"0x0I 0x3I |"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000003I",	"0x3I 0x0I |"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000003I",	"0x3I 0x3I |"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000007I",	"0x7I 0x3I |"), 
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000ffffffI","0xf0f0fI 0xf0f0f0I |"),
  TST(ID, SUCCESS, "0x000000000000000000000000ffffffffffffffffI",	"0xffffffff00000000I 0xffffffffI |"),
  TST(ID, SUCCESS, "0x000000000000000000000000ffffffffffffffffI",	"0xffffffffffffffffI 0x1010101010101010I |"),
  // ^ (bitwise exclusive OR)
  TST(INT64, STACK_UNDERFLOW, "",	"^"),
  TST(INT64, STACK_UNDERFLOW, "",	"1U ^"),
  TST(INT64, SUCCESS, "0",	"1U 1 ^"),
  TST(INT64, SUCCESS, "3",	"0U 3 ^"),
  TST(INT64, SUCCESS, "3",	"3U 0 ^"),
  TST(INT64, SUCCESS, "0",	"3U 3 ^"),
  TST(INT64, SUCCESS, "4",	"7U 3 ^"), 
  TST(INT64, SUCCESS, "0xffffff","0xf0f0fU 0xf0f0f0 ^"),
  TST(INT64, SUCCESS, "-1",	"0xffffffff00000000U 0xffffffff ^"),
  // Subtle: The reason for the '6' here is that the parser does not
  // wrap unsigned ints to signed ones.  Hence 0xfff..  is reall
  // 0x7fff by the time it is a Val_Int64...
  TST(INT64, SUCCESS, "0x6fefefefefefefef",	"0xffffffffffffffff 0x1010101010101010 ^"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000000I",	"0x1I 0x1I ^"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000003I",	"0x0I 0x3I ^"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000003I",	"0x3I 0x0I ^"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000000I",	"0x3I 0x3I ^"),
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000000004I",	"0x7I 0x3I ^"), 
  TST(ID, SUCCESS, "0x0000000000000000000000000000000000ffffffI", "0xf0f0fI 0xf0f0f0I ^"),
  TST(ID, SUCCESS, "0x000000000000000000000000ffffffffffffffffI", "0xffffffff00000000I 0xffffffffI ^"),
  TST(ID, SUCCESS, "0x000000000000000000000000efefefefefefefefI", "0xffffffffffffffffI 0x1010101010101010I ^"),
  // ~ (bitwise NOT)
  TST(INT64, STACK_UNDERFLOW, "",	"~"),
  TST(INT64, SUCCESS, "-2",	"1U ~"),
  // The following works because bitwise NOT of a string is '0'. 
  TST(INT64, SUCCESS, "-1",	"\"Hello\" ->i64 ~"),
  TST(INT64, SUCCESS, "-2",	"1 1U ~"),
  // 0xf0f0f0f0f0f0f0f0 = -1085102592571150096
  TST(INT64, SUCCESS, "-1085102592571150096","0x0f0f0f0f0f0f0f0f ~"),
  TST(INT64, SUCCESS, "0", "0xffffffffffffffffU ~"),
  // 0xefefefefefefefef = -1157442765409226769
  TST(INT64, SUCCESS, "-1157442765409226769",	"0x1010101010101010U ~"),
  TST(ID, SUCCESS, "0xfffffffffffffffffffffffffffffffffffffffeI", "0x1I ~"),
  TST(ID, SUCCESS, "0xffffffffffffffffffffffffffffffffffffffffI", "0x0I ~"),
  TST(ID, SUCCESS, "0xffffffffffffffffffffffffffff0f0f0f0f0f0fI", "0xf0f0f0f0f0f0I ~"),
  TST(ID, SUCCESS, "0xffffffffffffffffffffffff0000000000000000I", "0xffffffffffffffffI ~"),
  TST(ID, SUCCESS, "0xffffffffffffffffffffffffefefefefefefefefI", "0x1010101010101010I ~"),
  // % (integer modulus)
  TST(INT64, STACK_UNDERFLOW, "",	"%"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 %"),
  TST(INT64, SUCCESS, "0",	"1 1 %"),
  ...
  TST(INT64, SUCCESS, "-2",	"0xffffffffffffffffU -1 +"),
  // + (integer addition)
  TST(INT64, STACK_UNDERFLOW, "", "+"),
  TST(INT64, STACK_UNDERFLOW, "", "1 +"),
  ...
  TST(INT64, SUCCESS, "-1",	"1 2 -"),
  TST(INT64, SUCCESS, "2",	"1 -1 -"),
  TST(INT64, SUCCESS, "0",	"0xffffffffffffffffU -1 -"),
  // - (subtraction)
  TST(INT64, STACK_UNDERFLOW, "",	"-"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 -"),
  TST(INT64, SUCCESS, "1",	"1 \"Hello\" -"),
  ...
  TST(INT64, SUCCESS, "-2",	"0xffffffffffffffffU 2 *"),
  // * (integer multiplication)
  TST(INT64, STACK_UNDERFLOW, "",	"*"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 *"),
  TST(INT64, SUCCESS, "0",	"1 \"Hello\" *"),
  ...
  TST(INT64, SUCCESS, "0x0555555555555555", "0x0fffffffffffffff 3 /"),
  // / (integer division)
  TST(INT64, STACK_UNDERFLOW, "",	"/"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 /"),
  TST(INT64, DIVIDE_BY_ZERO, "",	"1 \"Hello\" /"),
  ...
  TST(INT64, SUCCESS, "1",	"0x7fffffffffffffff 2 >"),
  ...
  TST(INT64, SUCCESS, "1",	"-1 -2 >="),
  TST(INT64, SUCCESS, "0",	"-2 -1 >="),
  TST(INT64, SUCCESS, "1",	"0xffffffffffffffff 2 >="),
  // < (integer less-than)
  TST(INT64, STACK_UNDERFLOW, "",	"<"),
  TST(INT64, STACK_UNDERFLOW, "",	"1 <"),
  TST(INT64, SUCCESS, "0",	"1 \"Hello\" <"),
  ...
  TST(INT64, SUCCESS, "0",	"-1 -2 <"),
  TST(INT64, SUCCESS, "1",	"-2 -1 <"),
  TST(INT64, SUCCESS, "0",	"0xffffffffffffffff ->i64 2 <"),
  ...
  TST(INT64, SUCCESS, "0",	"-1 -2 <="),
  TST(INT64, SUCCESS, "1",	"-2 -1 <="),
  TST(INT64, SUCCESS, "0",	"0xffffffffffffffff 2 <="),
  ...
  TST(INT64, SUCCESS, "2000", "-2000 neg"),
  TST(INT64, SUCCESS, "0",	"0 neg"),
  TST(INT64, SUCCESS, "-1",	"1 ->i32 neg"),
  TST(INT64, SUCCESS, "1",	"-1 ->i32 neg"),
  TST(INT64, SUCCESS, "-2000","2000 ->i32 neg"),
  TST(INT64, SUCCESS, "2000", "-2000 ->i32 neg"),
  TST(INT64, SUCCESS, "0",	"0 ->i32 neg"),
  // + (floating-point addition)
  TST(DOUBLE, SUCCESS, "1.0",	"1.0 \"Hello\" +"),
  ...
  TST(DOUBLE, SUCCESS, "9999.99995",	"10000.0 0.00005 -"),
  TST(ID,     SUCCESS, "0x0000000000000000000000000000000000000008I",	"0x10I 0x8I -"),
  TST(ID,     SUCCESS, "0x0000000000000000000000000000000000000007I",	"0x10I 0x8I - 1 -"),
...
// Insert list tests here.
  ...
  // Hash tests
  TST(ID, SUCCESS, "0x2b196a354cb01379184d5754e6468dc2ab285439I", "1 sha1"),
