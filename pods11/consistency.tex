...
As a separate matter, many distributed systems are of such a large scale that replication of functionality is required to ensure good response times and availability.  
