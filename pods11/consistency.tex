...
\begin{definition}
A \lang program is {\em eventually consistent} with respect to a set of functional dependencies \wrm{all of which must use an underscore for the location attribute} over replicated state if the constraints are satisfied for any EDB.
\end{definition}
