...
\wrm{this is henceforth slightly wrong...}
...
\begin{algorithmic}[1]
  ...
  \If{\textsc{Coord} is applicable to $P'$}
  \State{$P \gets$ $\textsc{Coord}(P') \cup$\ rules removed from $P$ to make $P'$}
  \Else{\textbf{return} failure}
  \EndIf
  \EndIf
  \State{add rule shown above to $P$}
