...
\begin{example}
\label{ex:nonsugared}
Examples of local deductive, inductive, and asynchronous rules, respectively, where \dedalus{S} and \dedalus{T} are variables ranging over the temporal universe.
\\\\
deductive:
\begin{Dedalus}
p(#X, A, B, T) <- e(#X, A, B, T);
