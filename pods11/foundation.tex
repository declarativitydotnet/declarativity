...
Our goal in defining an operational formalism is to map real-world behavior to models of our logic program.  Our operational model of a distributed system is a distributed partial fixpoint computation.  As we will see, this naturally corresponds to our model-theoretic semantics.  
