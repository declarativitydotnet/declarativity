...
\vspace{1em}
\noindent {\bf EDB:}
By convention, EDB facts must be specified with a location, and without a time.  EDB facts are true at timestamp \dedalus{0}---the first timestamp.  Like Datalog, we require the EDB to be finite.
