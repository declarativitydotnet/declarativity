...
\jmh{Is the idea that \dedalus{\#s} is a constant?  Or that it's \dedalus{\#S} and ranges over the domain of \dedalus{node}?  I don't like hash-marks in front of constants much, but maybe it's unavoidable?}
...
\jmh{You're doing spatial entanglement here, which resurfaces the location specifiers in the body.  We can intro the notion of entanglement in the syntactic sugar section.}
\begin{Dedalus}
//sayer
