...
Inspired by those results, we here extended them to programs that are not syntactically 
monotone and channels that may drop or arbitrarily reorder messages.
...
distributed systems at a lower level than \lang, as a composition of state machines with explicitly specified  transition systems.
