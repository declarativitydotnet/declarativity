...
static const ValTest vtests[] = {
  ...
  TST(UINT64, STACK_UNDERFLOW, "",	"1 >>" ),
  TST(UINT64, SUCCESS, "0",	"1 1 >>" ),
  TST(UINT64, SUCCESS, "1",	"2 1 >>" ),
  TST(UINT64, SUCCESS, "4",	"16 2 >>" ),
  TST(UINT64, SUCCESS, "0x7fffffffffffffff","0xffffffffffffffffU 1 >>" ),
  TST(UINT64, SUCCESS, "0x3fffffffffffffff","-1 2 >>" ),
  ...
  TST(UINT64, STACK_UNDERFLOW, "",	"<<" ),
  TST(UINT64, STACK_UNDERFLOW, "",	"1 <<" ),
  TST(UINT64, SUCCESS, "2",	"1 1 <<" ),
  TST(UINT64, SUCCESS, "4",	"2 1 <<" ),
  TST(UINT64, SUCCESS, "64",	"16 2 <<" ),
  TST(UINT64, SUCCESS, "0xfffffffffffffffeU",	"0xffffffffffffffffU 1 <<" ),
  TST(UINT64, SUCCESS, "0xfffffffffffffffcU",	"-1 2 <<" ),
  // & (bitwise AND)
  TST(UINT64, STACK_UNDERFLOW, "",	"&" ),
  TST(UINT64, STACK_UNDERFLOW, "",	"1 &" ),
  TST(UINT64, SUCCESS, "1",	"1 1 &" ),
  TST(UINT64, SUCCESS, "0",	"0 3 &" ),
  TST(UINT64, SUCCESS, "0",	"3 0 &" ),
  TST(UINT64, SUCCESS, "3",	"3 3 &" ),
  TST(UINT64, SUCCESS, "3",	"7 3 &" ), 
  TST(UINT64, SUCCESS, "0","0xf0f0f 0xf0f0f0 &" ),
  ...
  TST(UINT64, STACK_UNDERFLOW, "",	"1 |" ),
  TST(UINT64, SUCCESS, "1",	"1 1 |" ),
  TST(UINT64, SUCCESS, "3",	"0 3 |" ),
  TST(UINT64, SUCCESS, "3",	"3 0 |" ),
  TST(UINT64, SUCCESS, "3",	"3 3 |" ),
  TST(UINT64, SUCCESS, "7",	"7 3 |" ), 
  TST(UINT64, SUCCESS, "0xffffff","0xf0f0f 0xf0f0f0 |" ),
  ...
  TST(UINT64, SUCCESS, "3",	"0 3 ^" ),
  TST(UINT64, SUCCESS, "3",	"3 0 ^" ),
  TST(UINT64, SUCCESS, "0",	"3 3 ^" ),
  TST(UINT64, SUCCESS, "4",	"7 3 ^" ), 
  TST(UINT64, SUCCESS, "0xffffff","0xf0f0f 0xf0f0f0 ^" ),
  TST(UINT64, SUCCESS, "0xffffffffffffffff",	"0xffffffff00000000U 0xffffffff ^" ),
  TST(UINT64, SUCCESS, "0xefefefefefefefef",	"0xffffffffffffffffU 0x1010101010101010 ^" ),
  // ~ (bitwise NOT)
  TST(UINT64, STACK_UNDERFLOW, "",	"~" ),
  TST(UINT64, SUCCESS, "0xfffffffffffffffe",	"1.0 ~" ),
  TST(UINT64, SUCCESS, "0xffffffffffffffff",	"\"Hello\" ~" ),
  TST(UINT64, SUCCESS, "0xfffffffffffffffe",	"1 1 ~" ),
  TST(UINT64, SUCCESS, "0xffff0f0f0f0f0f0f","0xf0f0f0f0f0f0 ~" ),
  TST(UINT64, SUCCESS, "0", "0xffffffffffffffffU ~" ),
  TST(UINT64, SUCCESS, "0xefefefefefefefef",	"0x1010101010101010 ~" ),
  // % (integer modulus)
  TST(INT64, STACK_UNDERFLOW, "",	"%" ),
  TST(INT64, STACK_UNDERFLOW, "",	"1 %" ),
