...
Figure~\ref{fig:kvs-budclass} combines ReplicatedKVS with a concrete implementation
of MulticastProtocol and DeliveryProtocol.  The resulting class, a subclass of Bud, 
may be instantiated and run in the background as shown in lines~\ref{line:instantiate} and~\ref{line:run}.
...
Reviewing the code in Figure~\ref{fig:kvs-impl}, we see the source of the non-monotonicity.  
