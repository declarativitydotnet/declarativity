...
Figures~\ref{fig:delivery-impl} and~\ref{fig:multicast-impl} show the remainder of the Bloom code used in this paper: best-effort protocols for unicast and multicast.
