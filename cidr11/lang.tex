...
overriding: a module may override interfaces defined by other mixins by simply redeclaring the interface.
Internally, these redundantly-named interfaces exist in the namespace of the module that declared them,
