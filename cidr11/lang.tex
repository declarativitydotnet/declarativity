...
Bloom programs manage state using four collection types described in the top of
...
line~\ref{line:dis_action_msg} of Figure~\ref{fig:pdg-disorderly} projects the
...
SQL aggregates; line~\ref{line:dis_count_reqid} of
...
methods; the order of statements is immaterial. Dividing rules into multiple
