...
right-hand side (rhs). In the Bud prototype, both sides of the operator are
instances of (a descendant of) a Ruby class called \texttt{BudCollection}, which
supports several useful methods for manipulating collections. Note that many of
these methods are provided by the standard Ruby \texttt{Enumerable} module,
which \texttt{BudCollection} imports.
