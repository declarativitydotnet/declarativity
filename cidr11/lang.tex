...
collections and an optional set of columns that specify the equijoin condition.
...
of the program. It also allows the use of Ruby's method overriding and
inheritance features: because a Bloom class is just a stylized Ruby class,
any of the methods in a Bloom class can be overridden by a sub-class.
...
particular implementation of this protocol can be chosen at runtime.
...
A common requirement 
 ...
 in a single module, and then provide
several concrete realizations of that module as mixins. 

it is purely declarative; this avoids forcing the
programmer to reason about the interaction between apparently-declarative rules
