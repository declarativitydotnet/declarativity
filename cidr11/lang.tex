...
\begin{figure}
	...
	\begin{tabular}{|p{0.65in}|p{2.35in}|}
		...
		\texttt{bc.flat\_map} & Takes a code block and returns the collection formed by the concatenated (flattened) results of running block once for every element in \texttt{bc}.\\
		...
		\texttt{bc.empty?} & Returns true if \texttt{bc} is empty.  Equivalent to negation in Datalog.\\
