...
\nrc{Phrasing of the first sentence seems awkward to me.} 
In many distributed programming circles today, conventional wisdom rejects distributed transactions in favor of application-level reasoning about eventual consistency.  But there are few concrete principles or tools to help programmers design and verify the correctness of eventually-consistent protocols.
