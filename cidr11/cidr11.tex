...
Bud}), and a powerful static analysis that identifies {\em points of order},
or edges in a dataflow graph corresponding to code that may require programmer attention to ensure consistency
in the face of message reordering.  {\em Bloom}'s design is motivated by
Hellerstein's CALM Conjecture, which provides a partially descriptive and
partially semantic characterization of eventually consistent programs. 
