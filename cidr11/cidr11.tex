...
Traditional programming models ensure strong consistency guarantees by exposing
transactions that allow atomic, arbitrary updates of replicated state.  Such
...
the recent interest in ``eventually consistentcy,'' a programming model that
...
places in the code that may require programmer attention to ensure consistency
