...
collections in a program.
 ...
 Before discussing the analysis itself, we first introduce the
graphical dataflow representation used 

 To simplify this task, we use a graphical dataflow
representation, which is d

Now that we have introduced the abstract key-value store protocol and two
concrete implemen
