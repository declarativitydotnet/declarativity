...
Figure~\ref{analysis-legend}

\subsection{Interface}

Figure~\ref{fig:kvs-proto} gives an abstract specification of a key-value store representing
...
Specifically, we may interact with a key-value store much as we would expect to interact
...
\subsection{Replicated implementation}
