...
to the shopping cart service using the CartProtocol. We assume that clients have
some mechanism for choosing which server replica to send requests to (e.g.,
