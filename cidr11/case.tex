...
\textbf{scratch} \texttt{kvput} is defined by the KeyValueStore module (XXX
...
\jmh{is the previous clause reasonable?}
...
on lines 22-23), and the item array in its value field is sent back to the client.  
...
8: end
9: 
10: kvput <= join([bigtable, action_msg]).map do |b, a|
