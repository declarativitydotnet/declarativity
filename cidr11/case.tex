...
implementation of MulticastProtocol with low message complexity \jmh{Probably we don't want to talk about ``complexity''.  Reword?}.

\jmh{I think a lot of the refs and line numbers in this paragraph are broken!!}
...
\vspace{-10pt}
\caption{Destructive cart analysis.  \jmh{These figs are a bit too small -- when I print them they're illegible.}}
