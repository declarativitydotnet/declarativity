...
in Figure~\ref{tab:pdf-destructive-analysis} indicates that there are points of order
between \texttt{action\_msg} and the temporal cluster, and between the temporal
cluster and itself.
...
%%end results.  
To ensure a consistent final state across all replicas, coordination between
the client and replicas may be required at each update to the cart.  One
...
throughput.  \wrm{The following is confusing because people might not have this
