...
\jmh{Not clear where distribution is: is kvstore replicated?  Is action\_msg a channel?}
...
\jmh{I think you mean if NOT found?  line 1 said ``unless'', not ``if''!}
...
\jmh{We didn't see iaction in the example code; deal with that.}
...
end results \jmh{what is different from what?}.  Although there is no syntactically obvious non-monotonicity in the destructive
