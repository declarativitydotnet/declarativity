...
checkout, we use the \texttt{accum} aggregate function to flatten the set of
items into an array.
...
monotonic, summarization of the cart state requires us to assume (or rather,
prove) that there will be no further cart actions.
