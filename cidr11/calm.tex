...
regardless of any read-write dataflow dependencies in the code.  As students of the logic programming literature will recognize~\cite{localstrat,ross-modular,ross-strat}, these conservative
