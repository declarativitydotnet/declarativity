...
This paper relates to work on concurrency control, distributed storage, and
...
transaction schedules that preserve some \emph{semantic} notion of correctness. In
