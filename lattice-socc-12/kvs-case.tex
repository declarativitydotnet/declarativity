...
lattices are useful; morever, the resulting key-value store implementation is
concise, readable, and has clear semantics.
...
built-in lattice.  \jmh{Does the 53 lines include the 30 of lpair?}
