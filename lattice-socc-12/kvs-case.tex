...
equivalent to a quorum replication system~\cite{Gifford1979}. This system allows
users to vary $R$ and $W$ on a per-operation basis, depending on the consistency
and durability requirements of their operations.

To support this feature, we can reuse the \lang quorum voting pattern first
introduced in 