...
redundancy and the key space is partitioned in some fashion to improve aggregate
...
record~\cite{DeCandia2007,Fidge1988,Mattern1989}. Clients get and put
...
between events~\cite{Fidge1988,Lamport1978,Mattern1989}. A vector clock is a map from node
