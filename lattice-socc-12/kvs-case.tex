...
Surprisingly, extending the KVS to support object versioning did not require
...
of Ruby but is completely generic, and would be suitable for inclusion among the
\lang built-in lattices.
