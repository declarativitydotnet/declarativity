...
values in Section~\ref{sec:kvs-versions}. \jmh{Ref statebox again?}  To handle a \emph{put(key, val)}
...
lattices (e.g., the \texttt{kv\_store} lattice).  Note also that \texttt{ip\_port} is
