...
key-value pair will converge to the same final state~\cite{vogels}.
...
resolve all conflicting updates made to the same key.
...
The KVS design proposed so far is sufficient for associating keys with lattice
values.
