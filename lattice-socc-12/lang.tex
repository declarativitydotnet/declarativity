...
the \texttt{lset} lattice (we omit a few \texttt{lset} methods for brevity).
...
lattice value is monotonic.  Monotone lattice methods provide a mechanism for
reasoning about composition of lattices or between lattices and collections.  By
including monotone lattice methods among the ``safe,'' monotonic constructs
provided by the Bloom language, we can easily extend our CALM analysis to \lang.
