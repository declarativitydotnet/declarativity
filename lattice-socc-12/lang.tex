...
behavior. To define a lattice in Bud, a developer creates a Ruby class that
meets a certain API contract. Figure~\ref{fig:lattice-lset} contains the Ruby
code for the \texttt{lset} lattice (note that we omit the implementation of a
few \texttt{lset} methods for brevity).
