...
Dedalus. It remains for us to extend our notion of model ordering to incorporate
lattices and prove that the point of confluence is the minimum model in that
ordering.
