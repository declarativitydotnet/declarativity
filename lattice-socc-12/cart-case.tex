...
In the previous section, we showed how a complex program can be composed via
monotonic mappings between simple lattice types. In this section, we demonstrate
how \lang can be used to define custom lattice types. This allows developers to
encode domain-specific notions of ``growth'' or ``forward progress''; as we will
