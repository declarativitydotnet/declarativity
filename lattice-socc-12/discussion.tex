...
garbage collection protocols are typically application-specific and can be
tricky to implement correctly. We are investigating ways in which \lang could
assist programmers in writing distributed garbage collection schemes. For
...
a natural representation using lattices. For example, a common property is that
once an operation has been applied by all replicas, information required to
