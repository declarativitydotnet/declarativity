...
\begin{abstract}
  ...
  consistent storage infrastructure. A standard technique, found in designs
  including such as Bayou, Escrow Transactions, and CRDTs, is to adopt a
  vocabulary of commutative operations; this eliminates concerns about message
  ordering.  A more powerful approach was recently captured by the \emph{CALM
