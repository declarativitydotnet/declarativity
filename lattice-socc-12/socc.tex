...
\begin{abstract}
  ...
  commutative operations; this avoids inconsistency due to message reordering.
  A more powerful approach was recently captured by the \emph{CALM Theorem},
  which proves that logically monotonic programs are guaranteed to be eventually
  consistent. The CALM Theorem can be used to verify the correctness of
  coordination-free programs in logic-based distributed languages such as Bloom.
  ...
  which brings the power of CALM analysis to whole programs containing arbitrary
