...
%%as expressive because its operational semantics (cite boom-eurosys) are essentially the same as the behavior of Algorithm 1.  Formalizing this
...
We believe that \lang is as expressive as Overlog, whose operational semantics~\cite{boom-eurosys} are essentially the same
