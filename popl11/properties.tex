...
\noindent{}Note that every monotonic Datalog program (without \dedalus{choice})
is confluent.
...
Intuitively, if all traces have the same associativity grouping 
...
with an associative program.  That is, there are two traces $R_1, R_2$ for $I$,
such that 
