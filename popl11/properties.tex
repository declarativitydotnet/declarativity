...
that the finiteness of the universe implies finite period of oscillation, we
...
If finiteness of the univese cannot be guaranteed, we can fall back on
...
instance: facts that are only ephemorally true represent events, or
...
If all traces of a a \lang instance produce the same ultimate model, then we
