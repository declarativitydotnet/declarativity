...
\wrm{Notice that fact $f$ may not be part of any support for itself}

\wrm{define complete support}
...
associativity.  By the Lemma above \wrm{which I haven't proved yet}, we know
