...
\begin{definition}
%
A {\em support} of fact $F$ in a \lang instance is a set of facts $E_1, \ldots,
E_n$, such that $\forall i \in 1 \ldots n (E_i \succ F)$.  If $E_1, \ldots, E_n$
are all non-negated, then we call it a {\em positive support}.
%
\end{definition}

It is clear that all facts in all incremental models of a monotonic \lang
instance have a positive support.
...
Let $T_1, T_2$ be two traces of a monotonic \lang instance with the same
associativity grouping.  Consider the ultimate models $U_1, U_2$ of the traces.


Before the point of divergence, program
