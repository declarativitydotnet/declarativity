...
state \wrm{eventually}. This weaker consistency model reduces the need for coordination among the
...
The intent of the rules defining {\tt s} is that {\tt s} contains an integer, initialized to
