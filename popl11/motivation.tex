...
\paa{cite event-driven prolog stuff here too}
%% and the interaction of
%%events and persistent tables or ``hard state'' allow the simulation of ``soft state'' %%\wrm{maybe it
%%would be helpful to say that soft state is a special case of mutable persistence: you mutate %%after a given time (clock tuple)} 
