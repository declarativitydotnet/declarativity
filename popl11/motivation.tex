...
%%although you could (transparently) intermix the types, their interaction wasn't always intuitive %%and their semantics were strictly operational in a majority of cases.
