...
support parallelism. 
\paa{I think 'concurrency' is the core issue that is addressed by our contribution.
'parallelism' is a correllary -- right?
Unfortunately, much of this order is {\em false order} --
