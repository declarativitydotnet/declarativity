...
%
\end{quote} 
\wrm{i googled this quote, and seems like people think its originally an einstein quote?  also, this should go in the abstract if we're feeling ballsy.}
...
\dedalus{p\pos($\overline{C}$)@k+1} fact.  By induction, we do not
deduce a \dedalus{p\pos($\overline{C}$)@j} fact for any $j > k$, unless
