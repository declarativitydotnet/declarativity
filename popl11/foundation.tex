...
functions that take sets as input and compute a scalar output -- as a shorthand
for common operations involving a number of rules.  We are interested in both
