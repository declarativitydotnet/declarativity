...
We call programs that always have a unique minimal model {\em monotonic} programs.

\jmh{I think that's defining a corollary of montonicity, no?  Or are you trying to capture non-syntactic monotonicity here?  I suspect this is a dangerous way to do that...} Adding negation or aggregation to Datalog
...
predicate range must over the \dedalus{time} domain.  
