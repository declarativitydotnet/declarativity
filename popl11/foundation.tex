...
monotonic logic is not expressive enough to capture interesting programs---computation
can never happen over an unbounded set.
...
\end{tabular}
\end{center}
\caption{Well-formed deductive, inductive, and asynchronous rules, and sugared versions}
\label{tbl:rules}
\end{table*}
