...
in-flight {\em cart\_update} tuples are idempotent \wrm{wait a minute, they're not quite idempotent.  if i send cart_update(Amazon.com, Ses1, $400)@1, then cart_update(Amazon.com, Ses1, $300)@2, then I retransmit cart_update(Amazon.com, Ses1, $400)@3, the $400 update will be reapplied.  also, i'm not sure why status and cart_update suddenly have 4 arguments in r2}
