...
at some time $N$, only to have a latecomer {\em cart\_action} tuple arrive at some time $M > N$.
...
that any latecomers are ignored---i.e., after a {\em checkout} has occurred, {\em action\_cnt}
