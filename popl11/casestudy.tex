...
\includegraphics[width=1.0\linewidth]{vizza_brick.pdf}
...
to ensure that the deduction of {\em action\_cnt} tuples {\em waits}.  
...
\dedalus{r4}, and having the server process updates in this order.
