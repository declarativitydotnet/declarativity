...
\caption{PDG diagram for the initial set-oriented shopping cart program.}
\label{fig:cs-pgd-1}
\end{figure}
...
\caption{PDG diagram for the shopping cart implementation that uses mutable state.}
\label{fig:cs-pdg-2}
\end{figure}
