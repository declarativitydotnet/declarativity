...
need to wait, or coordinate, to achieve the first condition.\nrc{I don't see that this is a requirement for EC at all. EC is just a loose consistency model; an implementation that is consistent with that model may or may not involve asynchrony. E.g., a strongly consistent system is trivially also ``eventually consistent.''}
