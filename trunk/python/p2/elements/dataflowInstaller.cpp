...
{
  class_< DataflowInstaller, bases<Element>,
    boost::shared_ptr<DataflowInstaller>, boost::noncopyable >
    ("DataflowInstaller", init< std::string, PlumberPtr,
     optional<boost::python::api::object> >())
