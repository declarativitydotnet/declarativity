...
% Statements in \ol end in periods.  The first two statements of the
...
% \ol rules have the general form 
% \begin{quote}
...
The complete \ol listing for a dynamic ring is as follows (it can be
