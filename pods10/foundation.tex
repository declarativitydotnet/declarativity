...
\dedalus{r\pos} may be reference in the body or head of any \slang rule.  
\dedalus{r\nega} is a predicate that we will use later to capture the notion of mutable state; we return to it in Section~\ref{sec:mutable}. 
Like {r\pos}, the use of {r\nega} is the heads and bodies of rules is unrestricted.
