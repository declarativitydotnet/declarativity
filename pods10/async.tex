...
Consider a predicate {m\_priority\_queue} as defined above, but with an extra integer attribute that contains the logical transmission
...
\rcs{try number 2 at a new example}
...
conventional descriptions of Lamport clocks. \rcs{END OF SECTION}
