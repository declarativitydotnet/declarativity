...
body contains predicates from exactly one subprogram.  The head of
an asynchronous rule may reference a relation in any subprogram, but the
...
possibility is that, due to caching or failure, comments begin to
