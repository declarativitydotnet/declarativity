...
\begin{figure}[t]
  ...
  %%\caption{Time moves forward in three ways: across strata, to the next fixpoint, and to some future fixpoint.}
   \caption{Dedalus admits inferences whose consequents are visible immediately, in the next timestep, or at some unspecified timestep.}
...
\wrm{Dave Maier says to define/give an example of choice.  Should we?}
