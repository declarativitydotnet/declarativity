...
It is easy to see that evaluation of an asynchronous rule may produce a tuple whose timestamp is less than the timestamps
...
\paa{rusty's stuff below, not yet glued}
