...
\paa{no, my notation is just broken.  how should we write it?  this also implies that the aggregates must follow the other attributes, which is too strict too}
