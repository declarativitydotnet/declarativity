...
introduce \lang, a superset of \slang that also admits the \emph{choice} construct~\cite{greedychoice}.
...
Entanglement is a surprisingly powerful construct that allows a rule
to reference the logical clock time of the deduction that produced one
(or more) of its subgoals.  In particular, it allows us to express
concepts such as infinite sequences, and therefore arbitrarily large
databases without admitting concepts such as function evaluation or
arithmetic to our language.
