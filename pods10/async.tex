...
\jmh{This needs a formal definition of a Distributed Program as a bunch of programs with non-overlapping predicates, and then a bunch of comm rules between them.}
