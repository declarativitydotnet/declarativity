...
\item Dedalus moves many tricky issues from updatable and distributed deductive databases (including table persistence, update, key constraints, and message delay and loss) from ambiguous type systems and operational semantics into the language itself, giving a logical interpretation for each.
