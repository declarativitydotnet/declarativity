...
\begin{abstract}
We present \textbf{Dedalus}, a syntactic subset of Datalog~\cite{ullmanbook} with negation, aggregate functions and choice.
Every Dedalus relation is extended with an integer attribute that intuitively represents the logical time at which a given tuple
holds.  We propose a sugared syntax in which rule head annotations indicate whether their conclusions hold at the same time as their
