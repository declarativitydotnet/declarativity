...
\title{{\huge{\bf\lang}}\titlenote{\small
...
%
Rastislav Bod\'{i}k$^\dagger$ \quad David Maier$^\ddagger$\\\\
%
...
into the logic language.  Thus, \lang allows concepts such as persistence,
updateable state, key constraints, and message delay and loss to be described
in a purely declarative fashion.  This capability allows us to express
...
%propose a sugared syntax in which rule head annotations indicate whether their
%conclusions hold at the same time as their premises, in the immediate next
%timestep, or at some unknown timestep.
...
corresponds to the class of modularly stratified~\cite{ross-syntactic,modular}
programs in Datalog.
%
\end{abstract}
