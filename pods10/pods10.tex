...
\lang reduces to of Datalog~\cite{ullmanbook} with negation, aggregate
functions and choice, and admits an explicit representation of time into the
logic language.  Thus, \lang allows concepts such as persistence, updateable
state, key constraints, and message delay and loss to be described in a purely
declarative fashion.  This capability allows us to express distributed systems
