...
then in $I_2$ there exists a ground atom that is not in $\alpha_j$ \wrm{don't get this.  do you think we should define minimal model and fixpoint before this?}  (and hence not in $\alpha_i$), and is not entailed by P given $\alpha_j$.  
