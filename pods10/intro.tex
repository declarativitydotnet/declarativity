...
asynchronous processing and communication including component failure.
We show how these features are captured in \lang via a natural
incorporation of {\em time} as an attribute of Datalog predicates.
