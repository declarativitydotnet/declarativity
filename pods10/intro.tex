...
In this paper we reconsider declarative programming for distributed systems from a model-theoretic perspective, via the introduction of a declarative language called \lang\footnote{\small
