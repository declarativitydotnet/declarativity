...
analysis.  \jmh{Reinsert an example---perhaps the first one discussed in the lattice section.}  We highlight a simple distributed program for which the CALM analysis
yields unsatisfactory results.  \jmh{Make sure to clarify that we're going to push beyond Bloom---both beyond the current state of the language, and also to the composition of software written in other languages.}
