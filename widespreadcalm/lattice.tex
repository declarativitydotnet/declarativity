...
\item \textbf{Controlled Non-Determinism:} Thus far, we have primarily been
  ...
  non-determinism to choose between two acceptable outcomes. \jmh{Expand a bit
    and connect to lattices.}
...
\item \textbf{Evaluations:} To validate that \blooml is useful for building
  ...
  proposed~\cite{Preguica2009,Weiss2009,Weiss2010}. Implementing these designs
