...
public class MultiPaxosTest {
    ...
    @Test
      ...
      @Test
        ...
        sked(this.systems[1],MASTER_PORT,"bar");
        pop = (String) queue.take();
        Assert.assertTrue(pop.compareTo("success") == 0);

        sked(this.systems[1],MASTER_PORT,"bas");
        pop = (String)queue.take();
        Assert.assertTrue(pop.compareTo("success") == 0);
    ...
    public static void main(String[] args) throws Exception {
        MultiPaxosTest t = new MultiPaxosTest();
        t.setup(5000,5001,5002);
        java.lang.System.err.println("OK, done with setup\n");
        t.simpleMultiPaxosTest();
        t.shutdown();
        //t.test3();
    }
}
