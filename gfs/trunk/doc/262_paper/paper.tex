...
paths. This separation has a long history in computer science, and can
be found in systems ranging from FTP~\cite{ftp-rfc} and DOT, to the
Berkeley Fast Filesystem and modern journalling
filesystems.\footnote{In these filesystems, metadata and data are
  subject to different consistency requirements and durability
  guarantees, and are implemented using different on-disk data
  structures.} Similarly, the separation of control and data is a
well-established principle in computer system
