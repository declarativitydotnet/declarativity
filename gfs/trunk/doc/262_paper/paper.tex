...
An Overlog program consists of \emph{rules}, 

When a BoomFS node is started, it begins by initializing an instance
of the JOL evaluator, and installing the BoomFS Overlog files into it.
...
More importantly, BoomFS is implemented in a combination of Java and
Overlog. BoomFS was relatively easy to implement; because the
implementation is concise and comprehensible, BoomFS can be extended
and adapted to new environments. BoomFS is the first member of a class
of data center infrastructure projects we plan to undertake under the
mantle of the BOOM project.
