...
distributed file system based on GFS, and evaluating its performance
on several workloads.  Our goal is to achieve competitive performance
on the large append and read workload characteristic of the GFS
environment, in spite of the increased control overhead of our Overlog
runtime.  In this section, we present an evaluation of how successful
we were in achieving this goal.

Because GFS is proprietary, we compared the performance of BoomFS and
HDFS. We performed our experiments on the Amazon Elastic Compute Cloud
...
workload, comparing read and write performance between BoomFS and HDFS
