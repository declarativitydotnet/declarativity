...
filesystem block sizes (64MB in the case of GFS). We focus on
...
policies in Section \ref{approach}, and by conducting a performance
...
simple, best-effort modules as place holders while we composed the
