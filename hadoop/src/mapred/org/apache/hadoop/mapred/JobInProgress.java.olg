...
class JobInProgress {
  ...
  public JobInProgress(JobID jobid, JobTracker jobtracker, 
    ...
    this.localJobFile = default_job_conf.getLocalPath(org.apache.hadoop.mapred.JobTracker.SUBDIR 
                                                      +"/"+jobid + ".xml");
    this.localJarFile = default_job_conf.getLocalPath(org.apache.hadoop.mapred.JobTracker.SUBDIR
                                                      +"/"+ jobid + ".jar");
