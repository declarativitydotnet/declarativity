...
of a the behavior of a program is precisely its set of stable models~\cite{sacca-zaniolo} %~\footnote{given a set of constraints that model happens-before~\cite{lamport}}.
