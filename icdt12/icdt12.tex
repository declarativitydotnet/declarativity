...
\begin{abstract}
  ...
  modeling distributed programs.  Unfortunately we show that \lang
  captures too broad a complexity class of programs (PSPACE) and
  ...
  only, making some natural distributed programs very inconvenient to
  ...
  PTIME complexity and confluence of \slang.
