...
Recently, Ameloot \etal explored Hellerstein's CALM theorem using
...
operational semantics similar to the operational semantics in \lang~\cite{relational-transducers},
