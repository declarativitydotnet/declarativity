...
Recently, Ameloot et al.\ explored Hellerstein's CALM conjecture using
...
Abiteboul et al.\ recently proposed Webdamlog, another distributed variant of
Datalog~\cite{Abiteboul2011}.
