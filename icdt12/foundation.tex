...
in Alvaro et al~\cite{dedalus}. We then review the model-theoretic semantics for \lang presented in~\cite{ameloot-operational}.  For simplicity, we use a somewhat similar exposition as~\cite{ameloot-operational}.
