...
S > T, choice((L, T, \(\overline{\dedalus{B}}\)),(S)).
\end{Dedalus}
...
!c\(\sb{1}\)(L,T,\(\overline{\dedalus{Y}\sb{1}}\)), \ldots, !c\(\sb{m}\)(L,T,\(\overline{\dedalus{Y}\sb{m}}\)), time(S),
S > T, choice((L, T, \(\overline{\dedalus{B}}\)),(S)), node(D).
\end{Dedalus}
