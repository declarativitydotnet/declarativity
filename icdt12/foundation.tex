...
\begin{Drules}
  \drule{p(\od{X\sub{0}})}
        {b\sub{1}(\od{X\sub{1}}), \ldots, b\sub{n}(\od{X\sub{n}}), !c\sub{1}(\od{Y\sub{1}}), \ldots, !c\_\sub{m}(\od{Y\sub{m}})}
\end{Drules}
...
\begin{Drules}
  \drule{p(D,S,\od{X\sub{0}})}
        {b\sub{1}(L,T,\od{X\sub{1}}), \ldots, b\sub{n}(L,T,\od{X\sub{n}}), !c\sub{1}(L,T,\od{Y\sub{1}}), \ldots, !c\sub{m}(L,T,\od{Y\sub{m}}), node(L), time(T), time(S), T < S, choice((L, T, \od{B}),(S)), node(D)}
\end{Drules}
