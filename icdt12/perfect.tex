...
rule, then collate these into \dedalus{done} relations for each relation.  We
handle deductive and asynchronous rules separately. The \dedalus{done} relation
for a deductive rule is complete when all of the relations in the body of the
rule are complete. The \dedalus{done} relation for an asynchronous rule is
