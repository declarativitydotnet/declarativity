...
\paa{bill, the text below may be way off due to my limited understanding of negation pushdown.  feel free to mangle}
...
It is not immediately obvious how to do this in a way that preserve the intended semantics of the program.
