...
the program statements need to be modified. Note that since the rewritten
program can be expressed in \slang, it is confluent and is therefore not subject
to the non-deterministic output observed for the original marriage program
(Example~\ref{ex:marriage}).
...
barrier to expressing practical programs.
