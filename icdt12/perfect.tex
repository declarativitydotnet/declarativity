...
handle deductive and asynchronous rules separately: a deductive rule is done at
the same time as its body relations; an asynchronous rule is done, intuitively,
when ``all messages have been acknowledged.''  We assume guarded asynchrony
applies to the rules in this section.
