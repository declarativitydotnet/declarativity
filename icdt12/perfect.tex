...
Then we provide an operational semantics for \plang, based on the one for \lang~\ref{ameloot-operational}, employing familiar coordination protocols from distributed systems.
