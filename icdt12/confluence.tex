...
outputs (multiple ultimate models), as well as nontrivial programs with an empty ultimate model.  Such programs are rarely desired and may indicate a bug.
%\nrc{Dubious:
...
\end{lemma}
This is perhaps not a surprising result, as confluence is defined over all EDBs.  We present a proof in the appendix.
