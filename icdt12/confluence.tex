...
%We assume that the derivation tree does not include nodes for \dedalus{time}, \dedalus{succ}, \dedalus{node}, or \dedalus{<}, or any relation introduced in the causality or \dedalus{choice} rewrites.
