...
// on Saturday, November 8, 2008 at 4:17:03 PM.
...
public final class Parser extends ParserBase {
      ...
      if (yyResult.hasValue("(")) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue(",")) {
            ...
            yyResult = pTimerType(yyResult.index);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
                      ...
                      if (yyResult.hasValue(",")) {
                        ...
                        if (yyResult.hasValue()) {
                          ...
                          if (yyResult.hasValue(")")) {
                            ...
                            yyValue = GNode.create("Timer", v$g$1, v$g$2, v$g$3, v$g$4, v$g$5);
                            yyValue.setLocation(location(yyStart));
  ...
  /**
   * Parse nonterminal jol.lang.parse.Parser.TimerType.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pTimerType(final int yyStart) throws IOException {
    Result     yyResult;
    String     yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    // Done.
    yyError = yyError.select("timer type expected", yyStart);
    return yyError;
  }
  ...
  private Result pPrimaryExpression$1(final int yyStart) throws IOException {
    ...
    // Alternative <ListValues>.

    yyResult = pValuesList(yyStart);
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      yyValue = yyResult.semanticValue();
  ...
  private Result pAggregate(final int yyStart) throws IOException {
    ...
    yyResult = pWord(yyStart);
    if (yyResult.hasValue("topk")) {
      final String v$g$3 = "topk";

      yyBase   = yyResult.index;
      yyResult = pSymbol(yyBase);
      if (yyResult.hasValue("<")) {

        yyResult = pAggregateVariable(yyResult.index);
        yyError  = yyResult.select(yyError);
        if (yyResult.hasValue()) {
          final Node v$g$4 = yyResult.semanticValue();
          ...
          if (yyResult.hasValue(",")) {
            ...
            yyResult = pIntegerConstant(yyChoice1);
            yyError  = yyResult.select(yyError);
            if (yyResult.hasValue()) {
              final Node v$g$5 = yyResult.semanticValue();
              ...
              if (yyResult.hasValue(">")) {
                ...
                yyValue = GNode.create("Aggregate", v$g$3, v$g$4, v$g$5);
                yyValue.setLocation(location(yyStart));
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue(">")) {
                ...
                yyValue = GNode.create("Aggregate", v$g$3, v$g$4, v$g$6);
                yyValue.setLocation(location(yyStart));
    ...
    yyResult = pWord(yyStart);
    if (yyResult.hasValue("bottomk")) {
      final String v$g$7 = "bottomk";
          ...
          if (yyResult.hasValue(",")) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue(">")) {
                ...
                yyValue = GNode.create("Aggregate", v$g$7, v$g$8, v$g$9);
                yyValue.setLocation(location(yyStart));
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue(">")) {
                ...
                yyValue = GNode.create("Aggregate", v$g$7, v$g$8, v$g$10);
                yyValue.setLocation(location(yyStart));
    ...
    yyResult = pWord(yyStart);
    if (yyResult.hasValue("limit")) {
      final String v$g$11 = "limit";
          ...
          if (yyResult.hasValue(",")) {
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue(">")) {
                ...
                yyValue = GNode.create("Aggregate", v$g$11, v$g$12, v$g$13);
                yyValue.setLocation(location(yyStart));
            ...
            if (yyResult.hasValue()) {
              ...
              if (yyResult.hasValue(">")) {
                ...
                yyValue = GNode.create("Aggregate", v$g$11, v$g$12, v$g$14);
                yyValue.setLocation(location(yyStart));
    ...
    yyError  = yyResult.select(yyError);
    if (yyResult.hasValue()) {
      final String v$g$15 = yyResult.semanticValue();
      ...
      if (yyResult.hasValue("<")) {
        ...
        if (yyResult.hasValue()) {
          ...
          if (yyResult.hasValue(">")) {
            ...
            yyValue = GNode.create("Aggregate", v$g$15, v$g$16);
            yyValue.setLocation(location(yyStart));
  ...
  private Result pAggregateVariable(final int yyStart) throws IOException {
    ParserColumn yyColumn = (ParserColumn)column(yyStart);
    if (null == yyColumn.chunk2) yyColumn.chunk2 = new Chunk2();
    if (null == yyColumn.chunk2.fAggregateVariable) 
      yyColumn.chunk2.fAggregateVariable = pAggregateVariable$1(yyStart);
    return yyColumn.chunk2.fAggregateVariable;
  }

  /** Actually parse jol.lang.parse.Parser.AggregateVariable. */
  private Result pAggregateVariable$1(final int yyStart) throws IOException {
    Result     yyResult;
    Node       yyValue;
    ParseError yyError = ParseError.DUMMY;
  ...
  /**
   * Parse nonterminal jol.lang.parse.Parser.ValuesList.
   *
   * @param yyStart The index.
   * @return The result.
   * @throws IOException Signals an I/O error.
   */
  private Result pValuesList(final int yyStart) throws IOException {
    Result     yyResult;
    int        yyBase;
    Node       yyValue;
    ParseError yyError = ParseError.DUMMY;
    ...
    if (yyResult.hasValue("[")) {
      ...
      if (yyResult.hasValue()) {
        ...
        if (yyResult.hasValue("]")) {
          ...
          yyValue = GNode.create("ValuesList", v$g$1);
          yyValue.setLocation(location(yyStart));
      ...
      if (yyResult.hasValue("]")) {
        ...
        yyValue = GNode.create("ValuesList", false);
        yyValue.setLocation(location(yyStart));
    ...
    // Done.
    yyError = yyError.select("values list expected", yyStart);
    return yyError;
  }
    ...
    if (yyResult.hasValue()) {
      ...
      while (true) {
        ...
        if (yyResult.hasValue(",")) {
          ...
          yyResult = pFloatConstant(yyResult.index);
          yyError  = yyResult.select(yyError, yyRepetition1);
          if (yyResult.hasValue()) {
            final Node v$el$1 = yyResult.semanticValue();
