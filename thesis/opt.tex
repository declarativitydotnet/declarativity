...
$IGroupID$.  The parent \ol{branch} provides the $Bound$ variable, which use
...
selection predicates, which resembles rule~\ol{sr5} in
...
f\_sizeof(GroupID)} predicate ensures this constraint.  This need for this
