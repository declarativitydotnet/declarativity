...
this initial set of known \ol{link} tuples, and present that result in a
relational view called \ol{path}~\footnote{Henceforth, referred to simply as a
``relation.''}.
...
tuple is included in the \ol{path} IDB relation.  The query predicate, shown at
