...
set boundingCommand = \$width"="\$ARGV\[0\]\;\$height"="\$ARGV\[1\]\;\$xmargin"="${xmargin}\;\$ymargin"="${ymargin}\;\$pageheight"="11\;\$LLX"="\$xmargin"*"72\;\$LLY"="\(\$ymargin\)"*"72\;\$ULX"="\(\$xmargin"+"\$width\)"*"72\;\$ULY"="\(\$ymargin\+\$height\)"*"72\;print\"\$LLX\ \$LLY\ \$ULX\ \$ULY\"
