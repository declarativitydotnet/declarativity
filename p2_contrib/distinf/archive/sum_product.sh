...
# /Users/kuangc/workspace/distinf/runOverLog -p 10000 -o running/0.shafer_shenoy.olg -DNODE_ADDR=\"localhost:10000\" -DMYID=0 -DLINKS_FILE=\"data/local4_links.csv\" -DVARS_FILE=\"data/local4_vars.csv\"

#/Users/kuangc/workspace/distinf/runOverLog -p 10001 -o running/1.shafer_shenoy.olg -DNODE_ADDR=\"localhost:10001\" -DMYID=1 -DLINKS_FILE=\"data/local4_links.csv\" -DVARS_FILE=\"data/local4_vars.csv\"
...
for ((i=0;i<N;i=i+1)) ; do
	...
	cp junctree_static.olg running/
