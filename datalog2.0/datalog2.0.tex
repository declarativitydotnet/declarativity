...
\author{Peter Alvaro\inst{1} \and William R. Marczak\inst{1} \and Neil Conway\inst{1} \and Joseph M. Hellerstin\inst{1} \and David Maier\inst{2} \and Russell Sears\inst{3}}

\authorrunning{Alvaro et al.}

\institute{University of California, Berkeley\\
\email{\{paa, wrm, nrc, hellerstein\}@cs.berkeley.edu}
\and
...
\keywords{Datalog, distributed systems, \wrm{what else}}
\end{abstract}
