...
across timesteps~\cite{deductiveupdates} rather than as a primitive.  We follow the approach of~\cite{deductiveupdates}---we add time suffixes to tuples, and define an equivalent notion of temporal stratification---but differ in several significant ways.
