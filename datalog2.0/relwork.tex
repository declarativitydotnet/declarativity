...
%\wrm{we need to be far more generous to Datalog/UT here...}
...
%(and encouraged) to observe very similar ideas in Statelog.  
...
Two distinguishing features of \lang with respect to TLA+ are our minimalist use of temporal constructs (\texttt{next} and \texttt{async}), and our unified treatment of temporal and other attributes of facts, enabling the full literature of Datalog to be applied both to temporal and instantaneous properties of programs.
...
Existing distributed deductive languages such as NDlog and Overlog adopt a
\emph{chain of fixpoints} interpretation. Evaluation proceeds in three phases:
