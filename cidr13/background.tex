...
\wrm{According to the Confluence Theorem, only batching, re-ordering, and atomizing are allowed.  However, in pratice, we can accept any well-typed timeline, as long as we ``double-check'' it with the evaluator.}
