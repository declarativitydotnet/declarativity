...
\jmh{Make more of the fact that vector clocks are a standard/classic mechanism in distributed systems.}
...
significantly, both protocols are monotonic. Since this agrees with our
intuition that these protocols make ``progress'' over time, this gives us more
confidence in the correctness of our designs.
