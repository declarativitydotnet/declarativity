...
schemes allow users to specify that certain operations can safely be commuted
...
\jmh{Can shorten this given new intro.}
\jmh{Intro discussion seems to apply better to CvRDTs (which are the lattices)
  than to CmRDTs.  Clarify here?}
