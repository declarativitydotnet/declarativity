...
analysis. By allowing application-specific notions of ``progress'' to be
represented as lattices and by enabling safe mappings between lattices, \lang
allows concise distributed programs that have clear semantic properties.
