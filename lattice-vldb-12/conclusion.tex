...
analysis.  Based on our experience to date, we feel that \lang provides developers with a mixture of conciseness and program analysis that are significantly richer than earlier approaches to distributed programming.
