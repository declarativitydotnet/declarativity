...
management, and the tradeoffs between transactions and weak
consistency. Programmers using distributed transactions are relieved of
consistency concerns but the the coordination protocols that are needed to
achieve strong consistency are widely believed to raise unacceptable challenges
in performance and operational overhead for modern
