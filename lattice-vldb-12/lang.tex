...
Mac OS X 10.7.3 and Ruby 1.8.7-p352. We ran each program variant four times on
each graph and report the average runtime.
...
length $n+1$ paths in the next step. Bloom and semi-naive \lang perform
competitively, which suggests that our implementation of semi-naive evaluation
for \lang is comparable with semi-naive evaluation for a traditional Datalog
system.
