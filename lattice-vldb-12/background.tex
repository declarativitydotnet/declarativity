...
program is non-monotonic and hence exhibits non-confluent behavior: the messages
sent by the program will depend on the order in which the elements of $A$ and
$B$ arrive.
...
latency and decrease availability in the event of network partitions, so in this
