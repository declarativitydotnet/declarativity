...
never ``retract'' a previous conclusion in the face of new evidence. A
non-monotonic operator does not have this property. For example, consider
computing the difference between two growing sets: $C = A - B$. As $A$ and $B$
grow, $C$ can both grow and shrink. In Bloom (and Datalog), a simple
