 ...
 * 1. Define new class Val_NAME in files val_NAME.h and val_NAME.C
 *    substituting NAME for the name of your new type.
 * 2. The new class must inherit from class Value and override
