...
for op, ar, va, desc in [
  ...
  ("restrict", 3, "F_RESTRICT", "restrict the factor to an assignment"),
  ("normalize", 1, "F_NORMALIZE", "returns a normalized version of a factor"),
  ("mean", 1, "F_MEAN", "returns the mean of a factor convertible to a moment_gaussian"),
